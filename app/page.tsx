...
import { LiveTradeItem, TradeItem } from "@/shared/ui/TradeItem";
                        ...
                        <div className={styles.leaderboardContent}>
                            ...
                            >
                                {tabTokens === "top tokens" && (
                                    <>
                                        <SwiperSlide
                                            className={styles.topTokensItem}
                                        >
                                            <div
                                                className={
                                                    styles.topTokensItemImg
                                                }
                                            >
                                                <Image
                                                    src="/img/pepe.png"
                                            ...
                                            <div
                                                className={
                                                    styles.topTokensItemContent
                                                }
                                            >
                                                <div
                                                    className={
                                                        styles.topTokensItemInfo
                                                    }
                                                >
                                                    <p
                                                        className={
                            ...
                            >
                                ...
                                <div className={styles.mainPointTextBlock}>
                                    ...
                                    <p className={styles.mainPointText}>
                                        No insiders, no rugpulls - pure math
                                        bullet point icon
                                    </p>
                                </div>
                        ...
                        <div className={styles.mainContentTop}>
                            ...
                            <div className={styles.mainContentFilters}>
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            className={styles.filterSelectTitle}
                                        >
                                            Soft by:
                                        </span>

                                        <span
                                            className={styles.filterSelectValue}
                                        >
                                            {sortByFilter}
                                        </span>
