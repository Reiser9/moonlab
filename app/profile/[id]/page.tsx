    ...
    return (
        <>
            <div className="profilePageTop">
                ...
                <div className="profilePageTextBlockInner">
                    <div className="profilePageTextBlock">
                        <p className="profilePageText">Points</p>

                        <p className="profilePageValue">0</p>
                    </div>

                    <div className="profilePageTextBlock">
                        <p className="profilePageText">Place</p>

                        <p className="profilePageValue">385730</p>
                    </div>

                    <div className="profilePageTextBlock">
                        <p className="profilePageText">Tier</p>
            ...
            <div className="profilePageStats">
                <p className="title2">Statistics</p>
                ...
                <div className="profilePageStatsItems">
                    ...
                    <div className="profilePageStatsItem">
                        ...
                        <div className="profilePageStatsItemValueInner">
                            <p className="profilePageStatsItemValue">0</p>
                            <p className="profilePageStatsItemText">
                                Closed Trades:
                            </p>
                    ...
                    <div className="profilePageStatsItem">
                        <p className="profilePageStatsItemTitle">Best Launch</p>
                    ...
                    <div className="profilePageStatsItem">
                        <p className="profilePageStatsItemTitle">Best Trade</p>
                    ...
                    <div className="profilePageStatsItem">
                        <p className="profilePageStatsItemTitle">Worst Trade</p>
            ...
            <div className="profilePageTokens">
                <div className="profilePageTokensHeader">
                    <p className="title2">Launched Tokens</p>
                    ...
                    <div className="profilePageTokensItem">
                        <div className="profilePageTokensItemInfo">
                                ...
                                <div className="profilePageTokensItemInfoTokenWrap">
                                    <div className="profilePageTokensItemInfoTokenIner">
                                        ...
                                        <div className="profilePageTokensItemInfoTokenTags">
                                            <p className="profilePageTokensItemInfoTokenTag active">
                                                Active
                                            </p>
                                            <p className="profilePageTokensItemInfoTokenTag">
                                                Flash
                                            </p>
                                        </div>
                                    </div>

                                    <p className="profilePageTokensItemInfoTokenStatus">
                                        Created 2h ago. Duration 12 m
                                    </p>
                                </div>
                            </div>

                            <div className="profilePageTokensItemInfoTextBlock">
                                <p className="profilePageTokensItemInfoTextTitle">
                                    Price
                                </p>
                            ...
                            <div className="profilePageTokensItemInfoTextBlock">
                                ...
                                <div className="profilePageTokensItemInfoTrades">
                                    ...
                                    <p className="profilePageTokensItemInfoTradesInfo">
                                        <span className="green">124b</span> /{" "}
                                        <span className="red">32s</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="profilePageTokensItemInfoMigration">
                                ...
                                <div className="profilePageTokensItemInfoMigrationSlider">
                                    ...
                                    <p className="profilePageTokensItemInfoMigrationSliderValue">
                                        204.5$ <span>/</span> 500$
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="profilePageTokensItemMigrate">
                            <div className="profilePageTokensItemMigrateTitleInner">
                                ...
                                <p className="profilePageTokensItemMigrateText">
                            ...
                            <p className="profilePageTokensItemMigrateValue">
                                Volume <span>209.9$</span>
                            </p>
                        </div>
